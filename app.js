System.register("Utils/Dictionnary", [], function (exports_1, context_1) {
    "use strict";
    var Dictionary;
...
System.register("DataBase/DatabaseModel", [], function (exports_2, context_2) {
    "use strict";
...
System.register("Utils/Guid", [], function (exports_3, context_3) {
    "use strict";
    var Guid;
...
System.register("Logical/Events", ["Utils/Dictionnary"], function (exports_4, context_4) {
    "use strict";
...
System.register("Model/Creature", ["Utils/Dictionnary", "DataBase/DatabaseSingleton", "Utils/Guid", "Logical/Events", "simpleGame"], function (exports_5, context_5) {
    "use strict";
    var Dictionnary_2, DatabaseSingleton_1, Guid_1, Events_1, simpleGame_1, CreatureFlags, Creature;
    ...
    return {
        setters: [
            ...
            function (simpleGame_1_1) {
                simpleGame_1 = simpleGame_1_1;
            }
        ],
        execute: function () {
            ...
            Creature = class Creature {
                ...
                Initialize() {
                    this._sprite = simpleGame_1.SimpleGame.overlays.Item(this._positionZ.toString()).create(this._positionX, this._positionY, 'model_' + this._entry);
                    simpleGame_1.SimpleGame.game.physics.enable(this._sprite, Phaser.Physics.ARCADE);
                ...
                MoveTo(posX, posY, idPosition = 1) {
                    ...
                    var tween = simpleGame_1.SimpleGame.game.add.tween(this._sprite);
                ...
                PlaySound(soundId) {
                    simpleGame_1.SimpleGame.game.add.audio('sound_' + soundId).play();
                }
...
System.register("Model/Spell", ["Utils/Guid", "simpleGame"], function (exports_6, context_6) {
    "use strict";
    var Guid_2, simpleGame_2, SpellType, SpellTargetType, SpellSounds, Spell;
    ...
    return {
        setters: [
            ...
            function (simpleGame_2_1) {
                simpleGame_2 = simpleGame_2_1;
            }
        ],
        execute: function () {
            (function (SpellType) {
            ...
            exports_6("SpellTargetType", SpellTargetType);
            ;
            ...
            exports_6("SpellSounds", SpellSounds);
            Spell = class Spell {
                constructor(ScriptName) {
                    this._scriptName = ScriptName;
                ...
                Launch() {
                    this._sprite = simpleGame_2.SimpleGame.overlays.Item(this._positionZ.toString()).create(this._positionX, this._positionY, 'model_' + this._modelId);
                    ...
                    simpleGame_2.SimpleGame.game.physics.enable(this._sprite, Phaser.Physics.ARCADE);
                    this._sprite.scale.setTo(this._scale, this._scale);
                }
                PlaySound(soundId) {
                    simpleGame_2.SimpleGame.game.add.audio('sound_' + soundId).play();
                }
                Dispose() {
                    ...
                    if (!this._isLaunched) {
                        ...
                        switch (this._typeCast) {
                            ...
                            case SpellTargetType.SPELL_TYPE_TARGET:
                                this._targetTween = simpleGame_2.SimpleGame.game.add.tween(this.Sprite);
            ...
            exports_6("Spell", Spell);
        }
    };
});
System.register("Model/SpellScript/spell_fadeout", ["Model/Spell", "simpleGame"], function (exports_7, context_7) {
    "use strict";
    var Spell_1, simpleGame_3, spell_fadeout;
    ...
    return {
        setters: [
            ...
            function (simpleGame_3_1) {
                simpleGame_3 = simpleGame_3_1;
            }
        ],
        execute: function () {
            spell_fadeout = class spell_fadeout extends Spell_1.Spell {
                ...
                Update(gameTime) {
                    if (!this.IsLaunched) {
                        var tween = simpleGame_3.SimpleGame.game.add.tween(this.Target.Sprite);
            ...
            exports_7("spell_fadeout", spell_fadeout);
        }
    };
});
System.register("Model/SpellScript/spell_fadein", ["Model/Spell", "simpleGame"], function (exports_8, context_8) {
    "use strict";
    var Spell_2, simpleGame_4, spell_fadein;
    ...
    return {
        setters: [
            ...
            function (simpleGame_4_1) {
                simpleGame_4 = simpleGame_4_1;
            }
        ],
        execute: function () {
            spell_fadein = class spell_fadein extends Spell_2.Spell {
                ...
                Update(gameTime) {
                    if (!this.IsLaunched) {
                        var tween = simpleGame_4.SimpleGame.game.add.tween(this.Target.Sprite);
            ...
            exports_8("spell_fadein", spell_fadein);
        }
    };
});
System.register("Logical/ScriptedSpell", ["Model/SpellScript/spell_fadeout", "Model/SpellScript/spell_fadein"], function (exports_9, context_9) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_9("ScriptedSpell", ScriptedSpell);
        }
    };
});
System.register("Model/CreatureScript/npc_hiboux", ["Model/Creature"], function (exports_10, context_10) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_10("npc_hiboux", npc_hiboux);
        }
    };
});
System.register("Model/CreatureScript/npc_cloud", ["Model/Creature"], function (exports_11, context_11) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_11("npc_cloud", npc_cloud);
        }
    };
});
System.register("Logical/ScriptedCreature", ["Model/CreatureScript/npc_hiboux", "Model/CreatureScript/npc_cloud"], function (exports_12, context_12) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_12("ScriptedCreature", ScriptedCreature);
        }
    };
});
System.register("Logical/Flags", [], function (exports_13, context_13) {
    "use strict";
    var Flags;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_13("Flags", Flags);
        }
    };
});
System.register("DataBase/DatabaseSingleton", ["Logical/ScriptedSpell", "Model/Spell", "Logical/ScriptedCreature", "Logical/Flags", "Model/Creature", "Utils/Dictionnary"], function (exports_14, context_14) {
    "use strict";
    var ScriptedSpell_1, Spell_3, ScriptedCreature_1, Flags_1, Creature_3, Dictionnary_3, DatabaseSingleton;
    ...
    return {
        ...
        execute: function () {
            DatabaseSingleton = class DatabaseSingleton {
                ...
                createDbObjects() {
                    this._gameCreatures = new Dictionnary_3.Dictionary();
                    var promises = [];
                    // CREATURE
                    promises.push(new Promise(resolve => {
                        this.creatures_db = new Dictionnary_3.Dictionary();
                    ...
                    // CREATURE TEMPLATE
                    promises.push(new Promise(resolve => {
                        this.creaturesTemplate_db = new Dictionnary_3.Dictionary();
                    ...
                    // MODELS
                    promises.push(new Promise(resolve => {
                        this.models_db = new Dictionnary_3.Dictionary();
                    ...
                    // SOUNDS
                    promises.push(new Promise(resolve => {
                        this.sounds_db = new Dictionnary_3.Dictionary();
                    ...
                    // SPELLS 
                    promises.push(new Promise(resolve => {
                        this.spells_db = new Dictionnary_3.Dictionary();
                    ...
                    // TEXTS
                    promises.push(new Promise(resolve => {
                        this.texts_db = new Dictionnary_3.Dictionary();
            ...
            exports_14("DatabaseSingleton", DatabaseSingleton);
        }
    };
});
/// <reference path="./../node_modules/phaser/typescript/phaser.d.ts"/>
System.register("simpleGame", ["Utils/Dictionnary", "DataBase/DatabaseSingleton"], function (exports_15, context_15) {
    "use strict";
    var Dictionnary_4, DatabaseSingleton_2, SimpleGame;
    ...
    return {
        ...
        execute: function () {/// <reference path="./../node_modules/phaser/typescript/phaser.d.ts"/>
            SimpleGame = class SimpleGame {
                ...
                create() {
                    SimpleGame.overlays = new Dictionnary_4.Dictionary();
            ...
            exports_15("SimpleGame", SimpleGame);
            window.onload = () => {
